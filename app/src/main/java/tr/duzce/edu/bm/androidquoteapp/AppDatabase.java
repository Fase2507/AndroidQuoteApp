...
@Database(entities = {FavoriteQuotes.class, User.class}, version = 12, exportSchema = false)
    ...
    public static synchronized AppDatabase getInstance(Context context) {
        if (instance == null) {
            instance = Room.databaseBuilder(context.getApplicationContext(),
                    ...
                    .fallbackToDestructiveMigration() // Hata durumunda veriyi temizleyip açar (Kasmayı önler)
                    .build();
        }
        return instance;
    }
