...
import android.widget.ImageView; // ImageView import eklendi
...
public class MainActivity extends AppCompatActivity {
                ...
                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                    ...
                    geminiService.categorizeQuote(currentQuote.getText(), new GeminiService.Callback() {
                        ...
                        public void onSuccess(String result) {
                            ...
                            // YENİ EKLENEN KOD: Kategori gelince arka planı güncelle!
                            arkaPlaniGuncelle(result);
                        ...
                        public void onError(Exception e) {
                            ...
                            // Hata olursa varsayılan arka plan (Wisdom) gelsin
                            arkaPlaniGuncelle("Wisdom");
    ...
    // YENİ EKLENEN KOD: Arka plan resmini değiştiren fonksiyon
    private void arkaPlaniGuncelle(String kategoriIsmi) {
        ImageView backgroundImageView = findViewById(R.id.backgroundImageView);

        // Eğer ImageView XML'de bulunamazsa uygulama çökmesin diye kontrol
        if (backgroundImageView == null) return;

        String temizKategori = kategoriIsmi.trim().toLowerCase();
        int resimId;

        switch (temizKategori) {
            case "love":
                resimId = R.drawable.bg_love;
                break;
            case "life":
                resimId = R.drawable.bg_life;
                break;
            case "motivation":
                resimId = R.drawable.bg_motivation;
                break;
            case "wisdom":
                resimId = R.drawable.bg_wisdom;
                break;
            case "humor":
                resimId = R.drawable.bg_humor;
                break;
            default:
                resimId = R.drawable.bg_wisdom;
                break;
        ...
        backgroundImageView.setImageResource(resimId);
    }
}